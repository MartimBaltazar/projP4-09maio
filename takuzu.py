...
class Board:
    ...
    def board_attibutes_setup(self):
        ...
        print("Pos livres por  linha:   ",self.livres_row)
        print("Pos livres por coluna:   ",self.livres_col,"\n")

        print("Zeros e Uns por linha:  ",self.row_values)
        print("Zeros e Uns por coluna: ",self.col_values,"\n")
        
        print("Número de pos livres:   ",self.num_pos_livres)
        print("Coordenadas pos livres: ",self.coord_pos,"\n")

        print("Adj verticais por pos:  ",self.adj_verticais)
        print("Adj horizontais por pos:",self.adj_horizontais,"\n")

        print("Adj cima por pos:     ",self.adj_cima)
        print("Adj baixo por pos:    ",self.adj_baixo,"\n")

        print("Adj esquerda por pos:  ",self.adj_esquerda)
        print("Adj direita por pos:   ",self.adj_direita,"\n")
...
# AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA          adj_verticais,[0,0])       AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
               ...
               #     exit()
            ...
            elif(condFlag == False and twoCheck == False):
                for num_linha,valores_linha in self.board.row_values.items():
                    if (valores_linha[0] == lim) and (valores_linha[1] != lim):
                        ...
                        if (posicao != []):
                            del self.board.coord_pos[posicao[0]]
        ...
        print("Número de pos livres:   ",self.board.num_pos_livres)
        print("Coordenadas pos livres: ",self.board.coord_pos,"\n")

        print("Adj verticais por pos:  ",self.board.adj_verticais)
        print("Adj horizontais por pos:",self.board.adj_horizontais,"\n")

        print("Adj cima por pos:     ",self.board.adj_cima)
        print("Adj baixo por pos:    ",self.board.adj_baixo,"\n")

        print("Adj esquerda por pos:  ",self.board.adj_esquerda)
        print("Adj direita por pos:   ",self.board.adj_direita,"\n")
